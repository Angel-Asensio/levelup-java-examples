...
public class CollectionMatchers {
    ...
    @Test
    public void collection_does_not_contain_element() {
        List<String> fruit = Lists.newArrayList(
                "apple", "banana", "pear", "blackberry", "grape");

        assertThat(fruit, org.hamcrest.core.IsNot.not(hasItem("cherry")));
    }
    ...
    public void collection_is_not_empty() {
        ...
        List<String> fruit = Lists.newArrayList(
                "apple", "banana", "pear", "blackberry", "grape");
        assertThat(fruit, org.hamcrest.CoreMatchers.not(empty()));
    }
